...
// android/build/config.mk 파일에 define 됨.
...
/*
   DM logging service start
*/
#define FAETURE_SKY_CP_DM_LOGGING
...
/* 
   SKT 요구사항으로 Roaming Debug Screen 추가
*/

#define FEATURE_SKY_CP_DEBUG_SCREEN_FOR_ROAMING
